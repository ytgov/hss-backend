...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "DENTAL"."DENTAL_SERVICE_SUBMISSIONS" (
    ...
    "DEPENDENT", "FILE_DENTAL", "ELIGIBLE_PHARMACARE", "showUrl", "HAS_COMMENTS"
) AS
SELECT
    DENTAL_SERVICE.ID,
...
SELECT
    ...
    CASE WHEN DENTAL_SERVICE.ARE_YOU_ELIGIBLE_FOR_THE_PHARMACARE_AND_EXTENDED_HEALTH_CARE_BEN IS NULL THEN 'Not Applicable'
    ELSE CAST(DENTAL_SERVICE.ARE_YOU_ELIGIBLE_FOR_THE_PHARMACARE_AND_EXTENDED_HEALTH_CARE_BEN AS VARCHAR2(500)) END AS ELIGIBLE_PHARMACARE,

...
SELECT
    ...
    CASE WHEN (SELECT COUNT(1) FROM DENTAL.DENTAL_SERVICE_DEPENDENTS where DENTAL_SERVICE.ID = DENTAL_SERVICE_DEPENDENTS.DENTAL_SERVICE_ID) > 0 THEN 'YES' ELSE 'NO' END AS DEPENDENT,

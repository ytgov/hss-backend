...
midwiferyRouter.post("/", async (req: Request, res: Response) => {
    try {
        ...
        .select('MIDWIFERY_SERVICES.ID',
                ...
                db.raw(`GENERAL.process_blob_value(DO_YOU_IDENTIFY_WITH_ONE_OR_MORE_OF_THESE_GROUPS_AND_COMMUNITIE, '${SCHEMA_MIDWIFERY}.MIDWIFERY_GROUPS_COMMUNITIES') AS DO_YOU_IDENTIFY_WITH_ONE_OR_MORE_OF_THESE_GROUPS_AND_COMMUNITIE
                `),
        ...
        if (sortBy) {
            switch (sortBy) {
                ...
                case "do_you_identify_with_one_or_more_of_these_groups_and_communitie":
                 query = query.orderByRaw(`GENERAL.process_blob_value(DO_YOU_IDENTIFY_WITH_ONE_OR_MORE_OF_THESE_GROUPS_AND_COMMUNITIE, '${SCHEMA_MIDWIFERY}.MIDWIFERY_GROUPS_COMMUNITIES')  ${sortOrder}`);
                    break;
                default:
    ...
    try {
        ...
        midwifery = await db(`${SCHEMA_MIDWIFERY}.MIDWIFERY_SERVICES`)
            ...
            .select('MIDWIFERY_SERVICES.ID',
                    ...
                    db.raw(`GENERAL.process_blob_value(DO_YOU_IDENTIFY_WITH_ONE_OR_MORE_OF_THESE_GROUPS_AND_COMMUNITIE, '${SCHEMA_MIDWIFERY}.MIDWIFERY_GROUPS_COMMUNITIES') AS DO_YOU_IDENTIFY_WITH_ONE_OR_MORE_OF_THESE_GROUPS_AND_COMMUNITIE,
                        GENERAL.process_blob_value(HOW_DID_YOU_FIND_OUT_ABOUT_THE_MIDWIFERY_CLINIC_SELECT_ALL_THAT, '${SCHEMA_MIDWIFERY}.MIDWIFERY_CLINIC_CONTACT_TYPES') AS HOW_DID_YOU_FIND_OUT_ABOUT_THE_MIDWIFERY_CLINIC_SELECT_ALL_THAT
                    `),
                    'MIDWIFERY_PREFERRED_CONTACT_TYPES.DESCRIPTION as preferred_contact',
                    'MIDWIFERY_BIRTH_LOCATIONS.DESCRIPTION AS BIRTH_LOCATIONS',

...
<template>
    <div class="dental-service-warnings">
        <v-row class="mb-5" no-gutters>
            <span class="title-service">Dental Service Possible Duplicates</span>
        </v-row>
...
import { DENTAL_DUPLICATES } from "../../urls.js";
